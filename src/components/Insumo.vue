            ...
            <q-dialog v-model="alert" persistent>
                <q-card class="" style="width: 700px">
                    ...
                    <q-card-actions align="right">
                        <q-btn v-if="accion === 1" color="red" class="text-white" :loading="useInsumo.loading"
                            @click="">Agregar
                            <template v-slot:loading>
                                <q-spinner color="primary" size="1em" />
                            </template>
                        </q-btn>
                        <q-btn v-if="accion !== 1" @click="" color="red" class="text-white" :loading="useInsumo.loading" >
                            Editar
                            <template v-slot:loading>
                                <q-spinner color="primary" size="1em" />
                            </template>
