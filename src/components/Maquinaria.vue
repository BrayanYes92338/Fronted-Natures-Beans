      ...
      <q-dialog v-model="alert" persistent>
        <q-card style="width: 700px">
          ...
          <q-select outlined v-model="idProveedor" use-input hide-selected fill-input input-debounce="0"
            class="q-my-md q-mx-md" :options="opciones" @filter="filtrarFn" label="Seleccionar el Proveedor">
          ...
          <!-- Input for Nombre -->
          <q-input outlined v-model="nombre" class="q-my-md q-mx-md" label="Nombre" type="text" required />
          <q-input outlined v-model="tipo" class="q-my-md q-mx-md" label="Tipo" type="text" required />
          <q-select outlined v-model="tipo" :options="['Maquina','Herramienta']" label="Seleccione Si es una Maquina o una Herramienta"
          class="q-my-md q-mx-md" />
          <!-- Input for Observaciones -->
          <q-input outlined v-model="observaciones" class="q-my-md q-mx-md" label="Observaciones" type="text"
            required />
          <!-- Input for Cantidad -->
          <q-input outlined v-model="cantidad" class="q-my-md q-mx-md" label="Cantidad" type="text" required />
          <!-- Input for Total (calculated, so possibly readonly) -->


          <q-card-actions align="right">
            <q-btn v-if="accion === 1" @click="validarIngresoMaquinaria()" color="red" class="text-white"
            ...
            <q-btn v-if="accion !== 1" @click="validarEdicionMaquinaria()" color="red" class="text-white"
      ...
      <q-table title="Maquinaria & Herramientas" title-class="text-green text-weight-bolder text-h4"
        ...
        <template v-slot:body-cell-opciones="props">
          <q-td :props="props">
            ...
            <q-btn color="green">
              <q-tooltip>
              Ver Registro de desinfeccion de la Herramienta
              </q-tooltip>
              <i class="fas fa-map-marker-alt"></i>
            </q-btn>
