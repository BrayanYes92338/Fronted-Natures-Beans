            ...
            <q-dialog v-model="alert" persistent>
                <q-card class="" style="width: 700px">
                    ...
                    <q-card-actions align="right">
                        <q-btn v-if="accion === 1" @click="validarIngresoPreparacionSuelo()" color="red" class="text-white"
                            :loading="usePreparacionSuelo.loading">Agregar
                            <template v-slot:loading>
                                <q-spinner color="primary" size="1em" />
                            </template>
                        </q-btn>
                        <q-btn v-if="accion !== 1" @click="validarEdicionPreparacionSuelo()" color="red" class="text-white"
                            :loading="usePreparacionSuelo.loading">
                            Editar
                            <template v-slot:loading>
                                <q-spinner color="primary" size="1em" />
                            </template>
        ...
        <div>
            <q-dialog persistent v-model="alerta2">
                <q-card class="" style="width: 700px">
                    ...
                    <q-card-actions align="right">
                        <q-btn color="red" class="text-white" :loading="usePreparacionSuelo.loading" @click="editarProductos()">
                            Editar
                            <template v-slot:loading>
                                <q-spinner color="primary" size="1em" />
                            </template>
        ...
        <div>
            <q-dialog v-model="modalProducto" persistent full-width>
                <q-card class="">
                    ...
                    <q-card-actions align="right">
                        <q-btn @click="abrir2(props?.row)" v-if="productos.length === 0" color="green" class="text-white"
                            :loading="usePreparacionSuelo.loading">
                            Agregar productos
                            <template v-slot:loading>
                                <q-spinner color="primary" size="1em" />
...
import { usePreparacionSueloStore } from "../stores/preparacionSuelos.js"
