    ...
    <div>
      <q-dialog v-model="alert" persistent>
        <q-card class="" style="width: 700px">
          ...
          <q-select outlined v-model="estadoFenológico"
            :options="['Germinación', 'Emergencia', 'Crecimiento Vegetativo', 'Desarrollo de Yemas/Floración', 'Fructificación', 'Maduración', 'Cosecha', 'Senescencia', 'Dormancia (en algunos cultivos)']"
            label="Seleccione el Estado Fenológico" class="q-my-md q-mx-md" />
