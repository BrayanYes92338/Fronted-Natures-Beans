<template>
    <div>
        ...
        <div>
            <q-dialog v-model="alert" persistent>
                <q-card style="width: 700px">
                    ...
                    <q-select outlined v-model="idEmpleados" use-input hide-selected fill-input input-debounce="0"
                        class="q-my-md q-mx-md" :options="optionsEmpleado" label="Seleccionar Empleado">
                        <template v-slot:no-option>
                            <q-item>
                                <q-item-section class="text-grey">Sin resultados</q-item-section>
                            </q-item>
                    ...
                    <q-select outlined v-model="idSemilla" use-input hide-selected fill-input input-debounce="0"
                        class="q-my-md q-mx-md" :options="optionsSemilla" label="Seleccionar Semilla">
                        <template v-slot:no-option>
                            <q-item>
                                <q-item-section class="text-grey">Sin resultados</q-item-section>
                            </q-item>
                    ...
                    <q-input outlined v-model="fechasiembra" use-input hide-selected fill-input input-debounce="0"
                        class="q-my-md q-mx-md" label="Fecha Siembra" type="date" />
        ...
        <div style="display: flex; justify-content: center">
            <q-table title="Siembras" title-class="text-green text-weight-bolder text-h4"
...
function traerSemilla(semilla) {
    ...
    cultivoAnterior.value = cultivoAnterior.value;
